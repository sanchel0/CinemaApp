...
{
    /// <inheritdoc />
    public partial class AddLocationEntitiesAndUpdateCinemaRelation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "Name", "IsoCode", "Email", "PhoneNumber" },
                values: new object[] { 1, "Argentina", "ARG", "contacto@argentina.gov", "+541112345678" }
            );
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Name", "StateId", "TimeZone" },
                values: new object[] { 1, "CABA", 1, "UTC-3" }
            );
